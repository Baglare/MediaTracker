...
export default function SocialProfileEditor({ authConfigured, authenticated, localPreferences, profileName, selectedTitle, media, progression, socialAvatarUrl, onProfileChanged }: { authConfigured: boolean; authenticated: boolean; localPreferences: ProfilePreferences; profileName: string; selectedTitle: string; media: MediaItem[]; progression: UserProgression; socialAvatarUrl?: string; onProfileChanged: () => void | Promise<void> }) {
