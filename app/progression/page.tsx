...
export default async function ProgressionPage() {
  ...
  return <SocialPageShell eyebrow="Yolculuk" title="İlerlemem" subtitle="XP V2 yolculuğun, dünyaların, uzmanlıkların, görevlerin ve rozetlerin." icon={<Trophy className="h-5 w-5" aria-hidden="true"/>} tone="progression">
    {!auth.userId ? <EmptyState title="İlerleme için oturum gerekli" description="XP V2 ilerlemeni ve kazandığın unvanları görmek için hesabınla giriş yap." /> : <ProgressionDashboard userId={auth.userId} />}
  </SocialPageShell>;
}
