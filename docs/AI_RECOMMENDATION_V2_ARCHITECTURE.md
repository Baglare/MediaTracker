...
- D6.6-2 tamamlandı: 21×5 ranked-tag coverage read-model'i, merkezi bounded provider request policy, request/cache/drift telemetry'si ve public AniList/TVMaze/Open Library canlı contract kapısı eklendi. TMDB/OMDb yalnız key bulunan ortamda koşullu kalır; [final kabul](AI_RECOMMENDATION_V2_FINAL_ACCEPTANCE.md).
