...
| D7 — Grounded Aspect Research Engine | D7-R2A direct-source foundation tamamlandı | Exact identity, citation-bound direct Wikimedia ve source-policy kontrollü targeted research foundation; D6 deterministic V2 authority kalır ([mimari](D7_GROUNDED_RESEARCH_ARCHITECTURE.md)) |
...
| D7-R2B — Search discovery adapter'ları | Planlandı | Ephemeral OpenAI Responses web_search ve optional Brave; adapter source değildir, underlying allowlisted URL gerekir |
