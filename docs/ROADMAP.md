...
| D7 — Grounded Aspect Research Engine | D7-R3B internal extraction hazır | Exact identity, revision-bound acquisition, transient packet, strict grounded observation ve deterministic claim/decision; D6 deterministic V2 authority kalır ([mimari](D7_GROUNDED_RESEARCH_ARCHITECTURE.md)) |
...
| D7-R4A — Shadow integration | Tamamlandı (internal/test) | Yalnız explicit unresolved must/avoid için bounded research; sonuç internal hypothetical telemetry'dir, D6 eligibility/ranking/public response değişmez ([shadow contract](D7_RESEARCH_SHADOW_INTEGRATION.md)) |
| D7-R4B — Shadow live acceptance | Planlandı | Conditional live provider kabulü, full regression/build ve stage budget gözlemi; authoritative integration yok |
