...
| D7 — Grounded Aspect Research Engine | D7-R1 saf foundation tamamlandı | Unresolved explicit constraint için exact identity'li, citation-bound ve source-policy kontrollü targeted research; D6 deterministic V2 eligibility/ranking authority kalır ([mimari](D7_GROUNDED_RESEARCH_ARCHITECTURE.md)) |
...
| D7-R2 — Direct source ve search adapter'ları | Planlandı | Wikidata/MediaWiki direct evidence ile ephemeral OpenAI Responses web_search ve optional Brave adapter'ları; production route'a bağlı değil |
| D7-R3 — Grounded claim extraction | Planlandı | Yalnız supplied passages, strict JSON/citation, contradiction/centrality ve no-source→unknown |
