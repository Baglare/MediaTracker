...
| D7-1B — Pilot annotation ve agreement | Hazırlık tamam; annotation başlamadı | Exact-field sparse plan UI/preview, 50+ all-selected confirmation ve private 27-pair pilot task planı hazır. Sonraki adım insan annotation, en az yüzde 20 bağımsız double annotation ve guideline revision; provider bulk fetch yok. |
