...
| D7 — Grounded Aspect Research Engine | D7-R3A internal acquisition/passage hazır | Exact identity, citation-bound direct Wikimedia, allowlisted ephemeral discovery ve transient passage packet; D6 deterministic V2 authority kalır ([mimari](D7_GROUNDED_RESEARCH_ARCHITECTURE.md)) |
...
| D7-R3B — Provider-neutral grounded extraction | Planlandı | Supplied-passage-only strict JSON/citation, contradiction/centrality ve no-source→unknown; LLM ranking yok |
