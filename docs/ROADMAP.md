...
| D6 — AI Recommendation V2 | D6-0–D6-5 tamamlandı | Domain/provider/evidence/deterministik ranking/editable UI/Feedback V2 ve stabilizasyon kabulü tamamlandı; canlı kalite garantisi değildir. D7 human-label değerlendirme ve kalibrasyondur ([kabul](AI_RECOMMENDATION_V2_ACCEPTANCE.md), [evaluation](AI_RECOMMENDATION_EVALUATION_CONTRACT.md), [demo](AI_RECOMMENDATION_V2_DEMO_SCRIPT.md), [plan](AI_RECOMMENDATION_V2_MIGRATION_PLAN.md)) |
