...
| D7 — Grounded Aspect Research Engine | D7-R2C multi-provider discovery tamamlandı | Exact identity, citation-bound direct Wikimedia ve allowlisted ephemeral multi-provider discovery; D6 deterministic V2 authority kalır ([mimari](D7_GROUNDED_RESEARCH_ARCHITECTURE.md)) |
