...
5. **Additive migrations:** Ledger'a göre eksik D2B.1 baseline ve D8 public profile theme additive migration uygulanır. Theme default `hidden` ve mevcut kullanıcıların public olmadığı post-check edilir.
