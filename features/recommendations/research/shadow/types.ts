...
export const GROUNDED_RESEARCH_ACTIVE_MAX_CANDIDATES = 3;
export const GROUNDED_RESEARCH_ACTIVE_MAX_JOBS = 3;
export const GROUNDED_RESEARCH_ACTIVE_TIMEOUT_MS = 12_000;
