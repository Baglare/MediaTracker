...
export const ASPECT_REGISTRY = {
  ...
  love_triangle: {
    ...
    descriptionTr: "Üç kişi arasında anlamlı romantik rekabet.", aliasesTr: ["romantik üçgen", "üçlü aşk"], aliasesEn: ["romantic triangle", "triangle romance"], supportedMediaTypes: ALL,
    providerSupport: { anilist: "strong", tvmaze: "experimental", tmdb: "experimental", omdb: "experimental", openlibrary: "partial" },
