...
export default function CalendarFeature({
  ...
  return (
    <div>
      ...
      />
      {model.recentLogs.length + model.plannedItems.length + model.activeItems.length === 0 ? (
        <EmptyState
          ...
          <div className="grid grid-cols-1 items-start gap-4 lg:grid-cols-2">
            ...
            <CalendarSection title="Yaklaşan bölümler">
              <div className="rounded-xl border border-dashed border-[var(--app-border-strong)] bg-[var(--app-surface-2)] p-4">
                <p className="text-sm font-medium text-[var(--app-text-primary)]">Gerçek yayın verisi bekleniyor</p>
                <p className="mt-1.5 text-xs leading-relaxed text-[var(--app-text-muted)]">
                  Mevcut yerel kayıtlar korunuyor; dış kaynak yayın takvimi gelmeden tahmin üretilmiyor.
                </p>
              </div>
            </CalendarSection>
          </div>
